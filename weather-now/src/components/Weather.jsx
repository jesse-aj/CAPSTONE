    ...
    <div className="flex min-h-screen flex-col bg-[#f5f7f8] dark:bg-[#0f1923]">
      ...
      <header className="flex flex-wrap items-center justify-between gap-4 border-b border-[#359EFF]/20 dark:border-[#359EFF]/30 px-4 sm:px-6 lg:px-10 py-4">
        <div className="flex items-center gap-3 text-slate-800 dark:text-white">
          <svg className="h-8 w-8 text-[#359EFF]" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
          ...
          <h2 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white">WeatherNow</h2>
        </div>
      ...
      <main className="flex flex-1 flex-col lg:flex-row overflow-hidden">
        {/* Weather Display */}
        <div className="flex-1 bg-cover bg-center p-4 sm:p-6 lg:p-8 min-h-[400px] lg:min-h-0" 
             style={{backgroundImage: "url('https://images.unsplash.com/photo-1534088568595-a066f410bcda?w=1200&auto=format&fit=crop')"}}>
          {loading && (
        ...
        <div className="w-full lg:w-96 shrink-0 border-t lg:border-t-0 lg:border-l border-[#359EFF]/20 dark:border-[#359EFF]/30 p-4 sm:p-6 overflow-y-auto">
          ...
          {Forcast.length > 0 && (
            <div className="mb-6">
              <h2 className="mb-4 text-xl font-bold text-slate-900 dark:text-white">5-Day Forecast</h2>
      ...
      <footer className="border-t border-[#359EFF]/20 dark:border-[#359EFF]/30 p-4 text-center">
        <p className="text-sm text-slate-500 dark:text-slate-400">Powered by OpenWeatherMap</p>
      </footer>
    </div>
  );
};
